...
const PROPERTIES = [
  ...
  { id: 21, address: "32605 Karina Pl", city: "Macon", state: "MO", zip: "63552", propertyType: "Manufactured Housing Park", status: "analyzing", source: "Broker Outreach", owner: "Seller (via Derrick, MHP Value — Derricks@mhpvalue.com, 229-232-9421)", dateFound: "2026-07-21", followUpDate: daysFromNow(4), followUpNote: "Request T12, POH titles/condition, DNR lagoon inspection report, rent comps, seller-financing term sheet", purchasePrice: 925000, arv: 1285000, rehabBudget: 15000, estProfit: 345000, actualProfit: null, notes: "Edgewood MHP — 17 sites: 1 tenant-owned home ($350/mo lot), 10 park-owned homes (~$350 lot + $488 home), 2 vacant POH (1 near rent-ready, 1 light remodel), 4 vacant infill lots. In-place cap 7.64%, entry COCR 11.04%. Possible seller financing (qualified investors only). Second parcel could add 2-3 more pads. New 6in sewer mains, no deferred maintenance per listing — unverified. ARV/profit are rough stabilized-lease-up estimates (7.5% cap on projected NOI), not underwritten. Listing: crexi.com/properties/2630839." },
];
