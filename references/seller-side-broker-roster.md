# Seller-Side Broker Roster

*Brokers and platforms who send Raimie MHP/RV park deal flow — built from a 180-day Gmail sweep, 2026-07-18. Reference this before starting a new sourcing sweep so outreach goes to warm contacts first.*

| Broker / Firm | Contact | Off-Market Signal | Track Record |
|---|---|---|---|
| **Jon Fisher — Mr. Land Man** | Jon@mrlandman.com / jonfisher1991@gmail.com | "Vast majority of my listings are off-market" | **Top relationship.** Sourced Shadybrook RV Park (IA, 72 sites, 10.73% cap, seller financing confirmed) — Doron responded positively. Regular newsletter + real back-and-forth. |
| **The MHP Broker** | Max Baker (CEO) max@themhpbroker.com; Michael Abdalla mabdalla@; Sameer Coelho scoelho@; Len Williams lwilliams@; Eric Wanck ewanck@; Spencer Schelp sschelp@; Vince Catanzaro vcatanzaro@ | Mixed — some sellers cash-only, some open to a 2nd | Highest listing volume of any source. Buy box already on file with them (sent 6/9). |
...
- "Any parks that came off market without selling?" (expired-listing angle — sent to Jon, Cole/Glenn, Max as of 2026-07-18)
- "Is the seller open to a creative structure?" (ask before requesting full package — saves time on cash-only deals)
